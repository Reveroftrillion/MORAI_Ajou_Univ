...
(cl:defclass <RobotOutput> (roslisp-msg-protocol:ros-message)
  ((drive_mode
   ...
   (is_attach_sig
    ...
    :type cl:boolean
    :initform cl:nil)
   (is_active_manipulator_brake
    :reader is_active_manipulator_brake
    :initarg :is_active_manipulator_brake
    :type cl:boolean
    :initform cl:nil))
)
...
(cl:ensure-generic-function 'is_active_manipulator_brake-val :lambda-list '(m))
(cl:defmethod is_active_manipulator_brake-val ((m <RobotOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:is_active_manipulator_brake-val is deprecated.  Use morai_msgs-msg:is_active_manipulator_brake instead.")
  (is_active_manipulator_brake m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotOutput>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'is_active_manipulator_brake) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotOutput>) istream)
  "Deserializes a message object of type '<RobotOutput>"
    ...
    (cl:setf (cl:slot-value msg 'is_active_manipulator_brake) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotOutput>)))
  ...
  "49a193ec7c5fd9ab9c19acfce71a8f77")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotOutput)))
  "Returns md5sum for a message object of type 'RobotOutput"
  "49a193ec7c5fd9ab9c19acfce71a8f77")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotOutput>)))
  ...
  (cl:format cl:nil "int32 drive_mode~%bool safe_mode_en~%bool is_obstacle~%int32 is_enabled~%bool is_collision~%bool is_emg_stop~%bool is_protect_stop~%bool is_brake~%bool is_speed_limit_on_safe_mode~%bool is_muting~%bool attach_exist~%int32 attach_mode~%bool is_attach_sig~%bool is_active_manipulator_brake~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotOutput)))
  "Returns full string definition for message of type 'RobotOutput"
  (cl:format cl:nil "int32 drive_mode~%bool safe_mode_en~%bool is_obstacle~%int32 is_enabled~%bool is_collision~%bool is_emg_stop~%bool is_protect_stop~%bool is_brake~%bool is_speed_limit_on_safe_mode~%bool is_muting~%bool attach_exist~%int32 attach_mode~%bool is_attach_sig~%bool is_active_manipulator_brake~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RobotOutput>))
  ...
  (cl:list 'RobotOutput
    ...
    (cl:cons ':is_active_manipulator_brake (is_active_manipulator_brake msg))
))
