...
class RobotOutput {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.is_active_manipulator_brake = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('is_active_manipulator_brake')) {
        this.is_active_manipulator_brake = initObj.is_active_manipulator_brake
      }
      else {
        this.is_active_manipulator_brake = false;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [is_active_manipulator_brake]
    bufferOffset = _serializer.bool(obj.is_active_manipulator_brake, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [is_active_manipulator_brake]
    data.is_active_manipulator_brake = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.is_active_manipulator_brake !== undefined) {
      resolved.is_active_manipulator_brake = msg.is_active_manipulator_brake;
    }
    else {
      resolved.is_active_manipulator_brake = false
    }
